...
LA035:  jsr     LB238                           ; A035 20 38 B2                  8.
        ...
        ldx     #$B9                            ; A03F A2 B9                    ..
        ldy     #$08                            ; A041 A0 08                    ..
        jsr     LA89F                           ; A043 20 9F A8                  ..
        jmp     LA05E                           ; A046 4C 5E A0                 L^.

; ----------------------------------------------------------------------------
LA049:  jsr     LB272                           ; A049 20 72 B2                  r.
        jmp     LA05E                           ; A04C 4C 5E A0                 L^.

; ----------------------------------------------------------------------------
LA04F:  .byte   $A9                             ; A04F A9                       .
LA050:  jmp     $4220                           ; A050 4C 20 42                 L B

; ----------------------------------------------------------------------------
        .byte   $B2                             ; A053 B2                       .
LA054:  lda     #$46                            ; A054 A9 46                    .F
        jsr     LB242                           ; A056 20 42 B2                  B.
...
LA1DD:  lda     #$1B                            ; A1DD A9 1B                    ..
        ...
        and     #$3F                            ; A1F0 29 3F                    )?
        ora     #$40                            ; A1F2 09 40                    .@
        jsr     LAB54                           ; A1F4 20 54 AB                  T.
        lda     $E7                             ; A1F7 A5 E7                    ..
        ora     #$68                            ; A1F9 09 68                    .h
        jsr     LAB54                           ; A1FB 20 54 AB                  T.
LA1FE:  jsr     LA120                           ; A1FE 20 20 A1                   .
        lda     #$FF                            ; A201 A9 FF                    ..
        sta     $FF                             ; A203 85 FF                    ..
        lda     #$1B                            ; A205 A9 1B                    ..
        jsr     LAB54                           ; A207 20 54 AB                  T.
        lda     #$46                            ; A20A A9 46                    .F
        jsr     LAB54                           ; A20C 20 54 AB                  T.
        lda     #$68                            ; A20F A9 68                    .h
...
LA2B7:  lda     #$03                            ; A2B7 A9 03                    ..
        ...
        lda     #$00                            ; A2C6 A9 00                    ..
        ldx     #$03                            ; A2C8 A2 03                    ..
LA2CA:  sta     $D004,x                         ; A2CA 9D 04 D0                 ...
        dex                                     ; A2CD CA                       .
...
; ----------------------------------------------------------------------------
LA33D:  jsr     LA367                           ; A33D 20 67 A3                  g.
        ...
        lda     #$AE                            ; A35D A9 AE                    ..
        ldx     #$B8                            ; A35F A2 B8                    ..
        jsr     LA89F                           ; A361 20 9F A8                  ..
        jmp     LA3C2                           ; A364 4C C2 A3                 L..

; ----------------------------------------------------------------------------
LA367:  jmp     LA6A2                           ; A367 4C A2 A6                 L..
...
LA596:  bvc     LA59C                           ; A596 50 04                    P.
        and     ($E3),y                         ; A598 31 E3                    1.
        bvs     LA59E                           ; A59A 70 02                    p.
LA59C:  ora     ($E3),y                         ; A59C 11 E3                    ..
LA59E:  sta     ($E3),y                         ; A59E 91 E3                    ..
        iny                                     ; A5A0 C8                       .
        rts                                     ; A5A1 60                       `
...
LA5D9:  sta     $C1                             ; A5D9 85 C1                    ..
        stx     $D005                           ; A5DB 8E 05 D0                 ...
        inx                                     ; A5DE E8                       .
        inx                                     ; A5DF E8                       .
        stx     $D004                           ; A5E0 8E 04 D0                 ...
LA5E3:  rts                                     ; A5E3 60                       `
...
; ----------------------------------------------------------------------------
        ...
        lda     #$1B                            ; A606 A9 1B                    ..
        jsr     LAB54                           ; A608 20 54 AB                  T.
        lda     #$50                            ; A60B A9 50                    .P
        jsr     LAB54                           ; A60D 20 54 AB                  T.
        lda     #$43                            ; A610 A9 43                    .C
        bne     LA63D                           ; A612 D0 29                    .)
LA614:  cmp     #$71                            ; A614 C9 71                    .q
        bne     LA621                           ; A616 D0 09                    ..
        lda     #$1B                            ; A618 A9 1B                    ..
        jsr     LAB54                           ; A61A 20 54 AB                  T.
        lda     #$4E                            ; A61D A9 4E                    .N
...
LA631:  lda     #$1B                            ; A631 A9 1B                    ..
        jsr     LAB54                           ; A633 20 54 AB                  T.
        lda     #$40                            ; A636 A9 40                    .@
LA638:  jsr     LAB54                           ; A638 20 54 AB                  T.
        lda     #$42                            ; A63B A9 42                    .B
LA63D:  jmp     LAB54                           ; A63D 4C 54 AB                 LT.
...
LA74E:  lda     LB9F4,y                         ; A74E B9 F4 B9                 ...
        ...
        bcc     LA75F                           ; A75B 90 02                    ..
        bne     LA768                           ; A75D D0 09                    ..
LA75F:  lda     ($F4),y                         ; A75F B1 F4                    ..
        ldx     $AB                             ; A761 A6 AB                    ..
...
LA7B4:  ldy     $EC                             ; A7B4 A4 EC                    ..
        ...
        and     ($E3),y                         ; A7BC 31 E3                    1.
        bvs     LA7C2                           ; A7BE 70 02                    p.
LA7C0:  ora     ($E3),y                         ; A7C0 11 E3                    ..
LA7C2:  sta     ($E3),y                         ; A7C2 91 E3                    ..
        ldx     #$02                            ; A7C4 A2 02                    ..
...
LA7E8:  clc                                     ; A7E8 18                       .
        ...
        adc     #$06                            ; A7EB 69 06                    i.
        sta     $F4                             ; A7ED 85 F4                    ..
        bcc     LA7F3                           ; A7EF 90 02                    ..
        inc     $F5                             ; A7F1 E6 F5                    ..
LA7F3:  jmp     LA673                           ; A7F3 4C 73 A6                 Ls.
...
; ----------------------------------------------------------------------------
LA89F:  sty     $EE                             ; A89F 84 EE                    ..
        sta     $EC                             ; A8A1 85 EC                    ..
        stx     $ED                             ; A8A3 86 ED                    ..
LA8A5:  ldy     $EE                             ; A8A5 A4 EE                    ..
        lda     ($EC),y                         ; A8A7 B1 EC                    ..
        jsr     LAB5D                           ; A8A9 20 5D AB                  ].
        dec     $EE                             ; A8AC C6 EE                    ..
        bpl     LA8A5                           ; A8AE 10 F5                    ..
...
LA963:  ldx     $02FC                           ; A963 AE FC 02                 ...
        ...
        lda     #$0B                            ; A971 A9 0B                    ..
        jmp     LB1DF                           ; A973 4C DF B1                 L..

; ----------------------------------------------------------------------------
LA976:  dex                                     ; A976 CA                       .
        bmi     LA9CE                           ; A977 30 55                    0U
        stx     $D8                             ; A979 86 D8                    ..
        lda     $D01F                           ; A97B AD 1F D0                 ...
        lsr     a                               ; A97E 4A                       J
...
LA9DD:  ldy     #$10                            ; A9DD A0 10                    ..
        ...
        and     #$07                            ; A9E7 29 07                    ).
        cmp     #$03                            ; A9E9 C9 03                    ..
        bne     LAA62                           ; A9EB D0 75                    .u
        lda     $022B                           ; A9ED AD 2B 02                 .+.
...
; ----------------------------------------------------------------------------
LAAA7:  jmp     LB272                           ; AAA7 4C 72 B2                 Lr.
...
LAAB8:  eor     #$FF                            ; AAB8 49 FF                    I.
        ...
        ldx     $C4                             ; AAC0 A6 C4                    ..
        stx     $D005                           ; AAC2 8E 05 D0                 ...
        inx                                     ; AAC5 E8                       .
        inx                                     ; AAC6 E8                       .
        stx     $D004                           ; AAC7 8E 04 D0                 ...
...
LAADB:  ldx     #$00                            ; AADB A2 00                    ..
        stx     $D005                           ; AADD 8E 05 D0                 ...
        stx     $D004                           ; AAE0 8E 04 D0                 ...
        stx     $B8                             ; AAE3 86 B8                    ..
        lda     $D0                             ; AAE5 A5 D0                    ..
...
LAB02:  jmp     LB1DF                           ; AB02 4C DF B1                 L..
...
; ----------------------------------------------------------------------------
LAB54:  jsr     LB1DF                           ; AB54 20 DF B1                  ..
        jmp     LB54F                           ; AB57 4C 4F B5                 LO.
...
LACFA:  lda     $E3                             ; ACFA A5 E3                    ..
        cmp     #$10                            ; ACFC C9 10                    ..
        bcs     LAD04                           ; ACFE B0 04                    ..
        lda     #$3E                            ; AD00 A9 3E                    .>
LAD02:  sta     $E4                             ; AD02 85 E4                    ..
LAD04:  rts                                     ; AD04 60                       `
...
LAD67:  bvc     LAD62                           ; AD67 50 F9                    P.
        lda     $D9                             ; AD69 A5 D9                    ..
        ora     $AB                             ; AD6B 05 AB                    ..
        and     ($E3),y                         ; AD6D 31 E3                    1.
LAD6F:  sta     ($E3),y                         ; AD6F 91 E3                    ..
        iny                                     ; AD71 C8                       .
        lda     $A7                             ; AD72 A5 A7                    ..
...
LAD83:  bvc     LAD7E                           ; AD83 50 F9                    P.
        lda     $D8                             ; AD85 A5 D8                    ..
        ora     $A7                             ; AD87 05 A7                    ..
        and     ($E3),y                         ; AD89 31 E3                    1.
LAD8B:  sta     ($E3),y                         ; AD8B 91 E3                    ..
LAD8D:  rts                                     ; AD8D 60                       `
...
LB087:  jmp     LE462                           ; B087 4C 62 E4                 Lb.
...
; ----------------------------------------------------------------------------
LB0DE:  bcs     LB0E5                           ; B0DE B0 05                    ..
        lda     LBA40,x                         ; B0E0 BD 40 BA                 .@.
        bne     LB0FD                           ; B0E3 D0 18                    ..
LB0E5:  jsr     LB137                           ; B0E5 20 37 B1                  7.
...
LB137:  lda     $C0                             ; B137 A5 C0                    ..
        ...
        adc     #$06                            ; B143 69 06                    i.
        sta     $C3                             ; B145 85 C3                    ..
LB147:  lda     $0590,x                         ; B147 BD 90 05                 ...
        sta     $0596,x                         ; B14A 9D 96 05                 ...
        lda     #$00                            ; B14D A9 00                    ..
        sta     $0590,x                         ; B14F 9D 90 05                 ...
        inx                                     ; B152 E8                       .
        dey                                     ; B153 88                       .
        bpl     LB147                           ; B154 10 F1                    ..
LB156:  rts                                     ; B156 60                       `
...
LB162:  sta     $C4                             ; B162 85 C4                    ..
        sta     $D005                           ; B164 8D 05 D0                 ...
        tax                                     ; B167 AA                       .
        inx                                     ; B168 E8                       .
        inx                                     ; B169 E8                       .
        stx     $D004                           ; B16A 8E 04 D0                 ...
LB16D:  rts                                     ; B16D 60                       `
...
LB2C6:  ldy     #$3F                            ; B2C6 A0 3F                    .?
        lda     #$20                            ; B2C8 A9 20                    . 
LB2CA:  cmp     ($FA),y                         ; B2CA D1 FA                    ..
        bne     LB2D1                           ; B2CC D0 03                    ..
        dey                                     ; B2CE 88                       .
        bpl     LB2CA                           ; B2CF 10 F9                    ..
LB2D1:  lda     #$9B                            ; B2D1 A9 9B                    ..
        iny                                     ; B2D3 C8                       .
...
LB2DC:  ldy     #$09                            ; B2DC A0 09                    ..
        sty     $0372                           ; B2DE 8C 72 03                 .r.
        ldy     $FA                             ; B2E1 A4 FA                    ..
        sty     $0374                           ; B2E3 8C 74 03                 .t.
        ldy     $FB                             ; B2E6 A4 FB                    ..
        sty     $0375                           ; B2E8 8C 75 03                 .u.
        jsr     LE456                           ; B2EB 20 56 E4                  V.
        lda     #$40                            ; B2EE A9 40                    .@
        clc                                     ; B2F0 18                       .
        adc     $FA                             ; B2F1 65 FA                    e.
        sta     $FA                             ; B2F3 85 FA                    ..
...
; ----------------------------------------------------------------------------
LB353:  lda     $1340                           ; B353 AD 40 13                 .@.
        cmp     #$1F                            ; B356 C9 1F                    ..
        bcs     LB353                           ; B358 B0 F9                    ..
        sei                                     ; B35A 78                       x
        jsr     LB369                           ; B35B 20 69 B3                  i.
        lda     $CB                             ; B35E A5 CB                    ..
        bne     LB365                           ; B360 D0 03                    ..
        jsr     LB545                           ; B362 20 45 B5                  E.
LB365:  cli                                     ; B365 58                       X
        ldy     #$01                            ; B366 A0 01                    ..
        rts                                     ; B368 60                       `

; ----------------------------------------------------------------------------
LB369:  ldy     $1342                           ; B369 AC 42 13                 .B.
        lda     $1347                           ; B36C AD 47 13                 .G.
        sta     $1310,y                         ; B36F 99 10 13                 ...
        jsr     LB55C                           ; B372 20 5C B5                  \.
        sta     $1342                           ; B375 8D 42 13                 .B.
        inc     $1340                           ; B378 EE 40 13                 .@.
        rts                                     ; B37B 60                       `
...
; ----------------------------------------------------------------------------
LB3D8:  jsr     LB3E7                           ; B3D8 20 E7 B3                  ..
        sta     $D20D                           ; B3DB 8D 0D D2                 ...
LB3DE:  lda     $D20E                           ; B3DE AD 0E D2                 ...
        and     #$08                            ; B3E1 29 08                    ).
...
LB3E7:  ldy     $1341                           ; B3E7 AC 41 13                 .A.
        ...
        pha                                     ; B3ED 48                       H
        jsr     LB55C                           ; B3EE 20 5C B5                  \.
        sta     $1341                           ; B3F1 8D 41 13                 .A.
        dec     $1340                           ; B3F4 CE 40 13                 .@.
        pla                                     ; B3F7 68                       h
        rts                                     ; B3F8 60                       `
...
LB429:  lda     $D20E                           ; B429 AD 0E D2                 ...
        and     #$08                            ; B42C 29 08                    ).
        bne     LB429                           ; B42E D0 F9                    ..
        lda     #$35                            ; B430 A9 35                    .5
        sta     $D303                           ; B432 8D 03 D3                 ...
        sta     $CB                             ; B435 85 CB                    ..
        sei                                     ; B437 78                       x
        jsr     LB369                           ; B438 20 69 B3                  i.
        cli                                     ; B43B 58                       X
        jsr     LB53A                           ; B43C 20 3A B5                  :.
LB43F:  ldy     LB47A,x                         ; B43F BC 7A B4                 .z.
        ldx     #$00                            ; B442 A2 00                    ..
        jsr     LB51F                           ; B444 20 1F B5                  ..
LB447:  lda     $CB                             ; B447 A5 CB                    ..
        ...
        sta     $CB                             ; B453 85 CB                    ..
        lda     #$3D                            ; B455 A9 3D                    .=
        sta     $D303                           ; B457 8D 03 D3                 ...
        lda     $133A                           ; B45A AD 3A 13                 .:.
        and     #$10                            ; B45D 29 10                    ).
        beq     LB464                           ; B45F F0 03                    ..
        sec                                     ; B461 38                       8
        bcs     LB471                           ; B462 B0 0D                    ..
LB464:  ldx     $1344                           ; B464 AE 44 13                 .D.
        txs                                     ; B467 9A                       .
        ldy     #$8B                            ; B468 A0 8B                    ..
        rts                                     ; B46A 60                       `
...
LB46B:  lda     #$3D                            ; B46B A9 3D                    .=
        sta     $D303                           ; B46D 8D 03 D3                 ...
        clc                                     ; B470 18                       .
LB471:  lda     $133A                           ; B471 AD 3A 13                 .:.
        and     #$EF                            ; B474 29 EF                    ).
        sta     $133A                           ; B476 8D 3A 13                 .:.
        rts                                     ; B479 60                       `
...
sub_b47d:
	sei                                     ; B47D 78                       x
        ...
        ldy     #$07                            ; B481 A0 07                    ..
        lda     #$00                            ; B483 A9 00                    ..
LB485:  sta     $133C,y                         ; B485 99 3C 13                 .<.
        dey                                     ; B488 88                       .
...
; ----------------------------------------------------------------------------
LB49B:  .byte   $9C                             ; B49B 9C                       .
        .byte   $B3                             ; B49C B3                       .
        dec     $B3                             ; B49D C6 B3                    ..
        dec     $B3                             ; B49F C6 B3                    ..
LB4A1:  sbc     $06B3,y                         ; B4A1 F9 B3 06                 ...
        .byte   $B4                             ; B4A4 B4                       .
...
; ----------------------------------------------------------------------------
LB51F:  lda     #$34                            ; B51F A9 34                    .4
        sta     $0226                           ; B521 8D 26 02                 .&.
        lda     #$B5                            ; B524 A9 B5                    ..
        sta     $0227                           ; B526 8D 27 02                 .'.
        sei                                     ; B529 78                       x
        lda     #$01                            ; B52A A9 01                    ..
        sta     $1345                           ; B52C 8D 45 13                 .E.
        jsr     LE45C                           ; B52F 20 5C E4                  \.
        cli                                     ; B532 58                       X
        rts                                     ; B533 60                       `

; ----------------------------------------------------------------------------
        lda     #$00                            ; B534 A9 00                    ..
        sta     $1345                           ; B536 8D 45 13                 .E.
        rts                                     ; B539 60                       `

; ----------------------------------------------------------------------------
LB53A:  sei                                     ; B53A 78                       x
        jsr     LB545                           ; B53B 20 45 B5                  E.
        cli                                     ; B53E 58                       X
LB53F:  lda     $1340                           ; B53F AD 40 13                 .@.
        bne     LB53F                           ; B542 D0 FB                    ..
        rts                                     ; B544 60                       `
...
; ----------------------------------------------------------------------------
LB54F:  ldx     #$00                            ; B54F A2 00                    ..
        ldy     #$03                            ; B551 A0 03                    ..
        jsr     LB51F                           ; B553 20 1F B5                  ..
LB556:  lda     $1345                           ; B556 AD 45 13                 .E.
        bne     LB556                           ; B559 D0 FB                    ..
        rts                                     ; B55B 60                       `
...
; ----------------------------------------------------------------------------
LB6C9:  lda     $CB                             ; B6C9 A5 CB                    ..
        beq     LB6C9                           ; B6CB F0 FC                    ..
        ldy     #$05                            ; B6CD A0 05                    ..
        sei                                     ; B6CF 78                       x
LB6D0:  lda     $1330,y                         ; B6D0 B9 30 13                 .0.
        ...
        sty     $133A                           ; B6E1 8C 3A 13                 .:.
        lda     #$57                            ; B6E4 A9 57                    .W
        jmp     LB802                           ; B6E6 4C 02 B8                 L..

; ----------------------------------------------------------------------------
        sta     $1347                           ; B6E9 8D 47 13                 .G.
        ldx     #$01                            ; B6EC A2 01                    ..
        stx     $21                             ; B6EE 86 21                    .!
LB6F0:  lda     $1340                           ; B6F0 AD 40 13                 .@.
        cmp     #$1F                            ; B6F3 C9 1F                    ..
...
LB724:  lda     #$00                            ; B724 A9 00                    ..
        ...
        lda     $133A                           ; B741 AD 3A 13                 .:.
        sta     $030A                           ; B744 8D 0A 03                 ...
        lda     #$09                            ; B747 A9 09                    ..
        sta     $0308                           ; B749 8D 08 03                 ...
        ldy     #$40                            ; B74C A0 40                    .@
        lda     #$58                            ; B74E A9 58                    .X
        jsr     LB802                           ; B750 20 02 B8                  ..
...
LB76F:  lda     $0209,x                         ; B76F BD 09 02                 ...
        ...
        cli                                     ; B78E 58                       X
        ldy     #$01                            ; B78F A0 01                    ..
        lda     $133A                           ; B791 AD 3A 13                 .:.
        sta     $2A                             ; B794 85 2A                    .*
        cpy     #$00                            ; B796 C0 00                    ..
        rts                                     ; B798 60                       `

; ----------------------------------------------------------------------------
LB799:  lda     #$00                            ; B799 A9 00                    ..
...
; ----------------------------------------------------------------------------
        lda     $1340                           ; B7DA AD 40 13                 .@.
        bne     LB7E4                           ; B7DD D0 05                    ..
        lda     $1346                           ; B7DF AD 46 13                 .F.
        sta     $CB                             ; B7E2 85 CB                    ..
LB7E4:  jmp     LB3C6                           ; B7E4 4C C6 B3                 L..

; ----------------------------------------------------------------------------
LB7E7:  lda     #$42                            ; B7E7 A9 42                    .B
        bit     $B1                             ; B7E9 24 B1                    $.
        bmi     LB7F1                           ; B7EB 30 04                    0.
        ldx     #$0A                            ; B7ED A2 0A                    ..
        bne     LB7F3                           ; B7EF D0 02                    ..
LB7F1:  ldx     #$00                            ; B7F1 A2 00                    ..
...
LB9AE:  brk                                     ; B9AE 00                       .
        ...
        .byte   $44                             ; B9B0 44                       D
        .byte   $84                             ; B9B1 84                       .
LB9B2:  .byte   $0C                             ; B9B2 0C                       .
        ora     LBEBC                           ; B9B3 0D BC BE                 ...
LB9B6:  php                                     ; B9B6 08                       .
...
; ----------------------------------------------------------------------------
        ...
        brk                                     ; BB0B 00                       .
        brk                                     ; BB0C 00                       .
        bpl     LBB3F                           ; BB0D 10 30                    .0
        lsr     $5E80,x                         ; BB0F 5E 80 5E                 ^.^
        bmi     LBB24                           ; BB12 30 10                    0.
        brk                                     ; BB14 00                       .
        .byte   $02                             ; BB15 02                       .
        .byte   $04                             ; BB16 04                       .
...
; ----------------------------------------------------------------------------
        bmi     LBBC6                           ; BB7C 30 48                    0H
        jsr     L4830                           ; BB7E 20 30 48                  0H
        .byte   $44                             ; BB81 44                       D
        .byte   $44                             ; BB82 44                       D
        sec                                     ; BB83 38                       8
        rti                                     ; BB84 40                       @
...
; ----------------------------------------------------------------------------
        ...
        bit     $24                             ; BB8D 24 24                    $$
        bit     $3A                             ; BB8F 24 3A                    $:
        jsr     LC020                           ; BB91 20 20 C0                   .
        brk                                     ; BB94 00                       .
        jsr     LA87C                           ; BB95 20 7C A8                  |.
        plp                                     ; BB98 28                       (
        plp                                     ; BB99 28                       (
        plp                                     ; BB9A 28                       (
        plp                                     ; BB9B 28                       (
...
; ----------------------------------------------------------------------------
        jsr     L2830                           ; BBDD 20 30 28                  0(
        bit     $28                             ; BBE0 24 28                    $(
        bmi     LBC44                           ; BBE2 30 60                    0`
        cpx     #$90                            ; BBE4 E0 90                    ..
        pha                                     ; BBE6 48                       H
        bit     $24                             ; BBE7 24 24                    $$
        pha                                     ; BBE9 48                       H
        ...
        brk                                     ; BC04 00                       .
        brk                                     ; BC05 00                       .
        bmi     LBC50                           ; BC06 30 48                    0H
        pha                                     ; BC08 48                       H
        bmi     LBC0B                           ; BC09 30 00                    0.
LBC0B:  brk                                     ; BC0B 00                       .
        brk                                     ; BC0C 00                       .
        bpl     LBC47                           ; BC0D 10 38                    .8
        .byte   $7C                             ; BC0F 7C                       |
        inc     $387C,x                         ; BC10 FE 7C 38                 .|8
        bpl     LBC15                           ; BC13 10 00                    ..
LBC15:  .byte   $82                             ; BC15 82                       .
        .byte   $44                             ; BC16 44                       D
        plp                                     ; BC17 28                       (
        bpl     LBC42                           ; BC18 10 28                    .(
        .byte   $44                             ; BC1A 44                       D
        .byte   $82                             ; BC1B 82                       .
        .byte   $04                             ; BC1C 04                       .
        php                                     ; BC1D 08                       .
LBC1E:  .byte   $10                             ; BC1E 10                       .
LBC1F:  brk                                     ; BC1F 00                       .
LBC20:  brk                                     ; BC20 00                       .
        brk                                     ; BC21 00                       .
        brk                                     ; BC22 00                       .
...
LBC30:  brk                                     ; BC30 00                       .
        ...
        brk                                     ; BC33 00                       .
        brk                                     ; BC34 00                       .
        bpl     LBC6F                           ; BC35 10 38                    .8
LBC37:  .byte   $7C                             ; BC37 7C                       |
        bpl     LBCB6                           ; BC38 10 7C                    .|
        sec                                     ; BC3A 38                       8
        bpl     LBC4D                           ; BC3B 10 10                    ..
        bpl     LBC4F                           ; BC3D 10 10                    ..
        bpl     LBC51                           ; BC3F 10 10                    ..
        .byte   $10                             ; BC41 10                       .
LBC42:  bpl     LBC54                           ; BC42 10 10                    ..
LBC44:  brk                                     ; BC44 00                       .
        brk                                     ; BC45 00                       .
        brk                                     ; BC46 00                       .
LBC47:  brk                                     ; BC47 00                       .
...
; ----------------------------------------------------------------------------
LBC4F:  brk                                     ; BC4F 00                       .
LBC50:  .byte   $50                             ; BC50 50                       P
LBC51:  .byte   $50                             ; BC51 50                       P
LBC52:  brk                                     ; BC52 00                       .
LBC53:  brk                                     ; BC53 00                       .
LBC54:  brk                                     ; BC54 00                       .
        brk                                     ; BC55 00                       .
        bvc     LBC50                           ; BC56 50 F8                    P.
        bvc     LBC52                           ; BC58 50 F8                    P.
        bvc     LBC5C                           ; BC5A 50 00                    P.
LBC5C:  rti                                     ; BC5C 40                       @

; ----------------------------------------------------------------------------
        beq     LBC1F                           ; BC5D F0 C0                    ..
        bmi     LBC51                           ; BC5F 30 F0                    0.
        jsr     L2090                           ; BC61 20 90 20                  . 
        jsr     L9040                           ; BC64 20 40 90                  @.
        brk                                     ; BC67 00                       .
        rti                                     ; BC68 40                       @

; ----------------------------------------------------------------------------
        ldy     #$40                            ; BC69 A0 40                    .@
        bcs     LBCBD                           ; BC6B B0 50                    .P
        brk                                     ; BC6D 00                       .
        .byte   $20                             ; BC6E 20                        
LBC6F:  rti                                     ; BC6F 40                       @
...
LBC71:  brk                                     ; BC71 00                       .
        brk                                     ; BC72 00                       .
        brk                                     ; BC73 00                       .
        jsr     L4040                           ; BC74 20 40 40                  @@
        rti                                     ; BC77 40                       @

; ----------------------------------------------------------------------------
        jsr     L4000                           ; BC78 20 00 40                  .@
        jsr     L2020                           ; BC7B 20 20 20                    
        rti                                     ; BC7E 40                       @

; ----------------------------------------------------------------------------
        brk                                     ; BC7F 00                       .
        bcc     LBCE2                           ; BC80 90 60                    .`
        beq     LBCE4                           ; BC82 F0 60                    .`
        bcc     LBC86                           ; BC84 90 00                    ..
LBC86:  jsr     LF820                           ; BC86 20 20 F8                   .
        jsr     L0020                           ; BC89 20 20 00                   .
        brk                                     ; BC8C 00                       .
        brk                                     ; BC8D 00                       .
        rti                                     ; BC8E 40                       @
...
; ----------------------------------------------------------------------------
        bcc     LBC37                           ; BCA5 90 90                    ..
        bcc     LBD09                           ; BCA7 90 60                    .`
        brk                                     ; BCA9 00                       .
LBCAA:  jsr     L2060                           ; BCAA 20 60 20                  ` 
        jsr     L0070                           ; BCAD 20 70 00                  p.
LBCB0:  rts                                     ; BCB0 60                       `

; ----------------------------------------------------------------------------
        bcc     LBCD3                           ; BCB1 90 20                    . 
        rti                                     ; BCB3 40                       @

; ----------------------------------------------------------------------------
        beq     LBCB6                           ; BCB4 F0 00                    ..
LBCB6:  .byte   $F0                             ; BCB6 F0                       .
LBCB7:  .byte	$10,$20
        .byte	$10,$E0
        brk                                     ; BCBB 00                       .
        .byte   $20                             ; BCBC 20                        
...
LBCBF:  .byte	$F0,$20
LBCC1:  brk                                     ; BCC1 00                       .
LBCC2:  cpx     #$80                            ; BCC2 E0 80                    ..
        cpx     #$10                            ; BCC4 E0 10                    ..
LBCC6:  cpx     #$00                            ; BCC6 E0 00                    ..
LBCC8:  rts                                     ; BCC8 60                       `

; ----------------------------------------------------------------------------
LBCC9:  .byte   $80                             ; BCC9 80                       .
        cpx     #$90                            ; BCCA E0 90                    ..
        cpx     #$00                            ; BCCC E0 00                    ..
        beq     LBCE0                           ; BCCE F0 10                    ..
        jsr     L4040                           ; BCD0 20 40 40                  @@
LBCD3:  brk                                     ; BCD3 00                       .
LBCD4:  rts                                     ; BCD4 60                       `

; ----------------------------------------------------------------------------
        bcc     LBD37                           ; BCD5 90 60                    .`
        bcc     LBD39                           ; BCD7 90 60                    .`
        brk                                     ; BCD9 00                       .
        rts                                     ; BCDA 60                       `

; ----------------------------------------------------------------------------
        bcc     LBD4D                           ; BCDB 90 70                    .p
        bpl     LBCBF                           ; BCDD 10 E0                    ..
        brk                                     ; BCDF 00                       .
LBCE0:  brk                                     ; BCE0 00                       .
        rti                                     ; BCE1 40                       @
...
; ----------------------------------------------------------------------------
        .byte   $80                             ; BCEA 80                       .
        brk                                     ; BCEB 00                       .
LBCEC:  jsr     L8040                           ; BCEC 20 40 80                  @.
        rti                                     ; BCEF 40                       @

; ----------------------------------------------------------------------------
LBCF0:  .byte   $20                             ; BCF0 20                        
        brk                                     ; BCF1 00                       .
LBCF2:  brk                                     ; BCF2 00                       .
        beq     LBCF5                           ; BCF3 F0 00                    ..
LBCF5:  beq     LBCF7                           ; BCF5 F0 00                    ..
LBCF7:  brk                                     ; BCF7 00                       .
LBCF8:  rti                                     ; BCF8 40                       @
...
; ----------------------------------------------------------------------------
        bcc     LBCFD                           ; BD0B 90 F0                    ..
        bcc     LBC9F                           ; BD0D 90 90                    ..
        brk                                     ; BD0F 00                       .
        cpx     #$90                            ; BD10 E0 90                    ..
        cpx     #$90                            ; BD12 E0 90                    ..
        .byte   $E0                             ; BD14 E0                       .
LBD15:  brk                                     ; BD15 00                       .
        bvs     LBC98                           ; BD16 70 80                    p.
        .byte   $80                             ; BD18 80                       .
        .byte   $80                             ; BD19 80                       .
LBD1A:  bvs     LBD1C                           ; BD1A 70 00                    p.
LBD1C:  cpx     #$90                            ; BD1C E0 90                    ..
LBD1E:  bcc     LBCB0                           ; BD1E 90 90                    ..
        .byte   $E0                             ; BD20 E0                       .
LBD21:  brk                                     ; BD21 00                       .
        beq     LBCA4                           ; BD22 F0 80                    ..
        cpx     #$80                            ; BD24 E0 80                    ..
LBD26:  beq     LBD28                           ; BD26 F0 00                    ..
LBD28:  .byte   $F0                             ; BD28 F0                       .
LBD29:  .byte   $80                             ; BD29 80                       .
LBD2A:  cpx     #$80                            ; BD2A E0 80                    ..
LBD2C:  .byte   $80                             ; BD2C 80                       .
        brk                                     ; BD2D 00                       .
        rts                                     ; BD2E 60                       `

; ----------------------------------------------------------------------------
        .byte   $80                             ; BD2F 80                       .
        bcc     LBCC2                           ; BD30 90 90                    ..
        bvs     LBD34                           ; BD32 70 00                    p.
LBD34:  bcc     LBCC6                           ; BD34 90 90                    ..
        .byte   $F0                             ; BD36 F0                       .
LBD37:  bcc     LBCC9                           ; BD37 90 90                    ..
LBD39:  brk                                     ; BD39 00                       .
        cpx     #$40                            ; BD3A E0 40                    .@
        rti                                     ; BD3C 40                       @
...
; ----------------------------------------------------------------------------
        cpx     #$00                            ; BD3E E0 00                    ..
        bpl     LBD52                           ; BD40 10 10                    ..
        bpl     LBCD4                           ; BD42 10 90                    ..
        rts                                     ; BD44 60                       `

; ----------------------------------------------------------------------------
        brk                                     ; BD45 00                       .
        bcc     LBCE8                           ; BD46 90 A0                    ..
        cpy     #$A0                            ; BD48 C0 A0                    ..
        bcc     LBD4C                           ; BD4A 90 00                    ..
LBD4C:  .byte   $80                             ; BD4C 80                       .
LBD4D:  .byte   $80                             ; BD4D 80                       .
        .byte   $80                             ; BD4E 80                       .
        .byte   $80                             ; BD4F 80                       .
        beq     LBD52                           ; BD50 F0 00                    ..
LBD52:  dey                                     ; BD52 88                       .
        cld                                     ; BD53 D8                       .
        tay                                     ; BD54 A8                       .
        dey                                     ; BD55 88                       .
        dey                                     ; BD56 88                       .
        brk                                     ; BD57 00                       .
        bcc     LBD2A                           ; BD58 90 D0                    ..
        bcs     LBCEC                           ; BD5A B0 90                    ..
        bcc     LBD5E                           ; BD5C 90 00                    ..
LBD5E:  beq     LBCF0                           ; BD5E F0 90                    ..
        bcc     LBCF2                           ; BD60 90 90                    ..
        beq     LBD64                           ; BD62 F0 00                    ..
LBD64:  cpx     #$90                            ; BD64 E0 90                    ..
LBD66:  cpx     #$80                            ; BD66 E0 80                    ..
        .byte   $80                             ; BD68 80                       .
        brk                                     ; BD69 00                       .
        beq     LBCFC                           ; BD6A F0 90                    ..
        bcc     LBD1E                           ; BD6C 90 B0                    ..
        sed                                     ; BD6E F8                       .
        brk                                     ; BD6F 00                       .
LBD70:  cpx     #$90                            ; BD70 E0 90                    ..
        cpx     #$A0                            ; BD72 E0 A0                    ..
        bcc     LBD76                           ; BD74 90 00                    ..
LBD76:  .byte   $70                             ; BD76 70                       p
LBD77:  .byte   $80                             ; BD77 80                       .
        cpx     #$10                            ; BD78 E0 10                    ..
        cpx     #$00                            ; BD7A E0 00                    ..
        sed                                     ; BD7C F8                       .
...
; ----------------------------------------------------------------------------
        ...
        dey                                     ; BD92 88                       .
        brk                                     ; BD93 00                       .
        bcc     LBD26                           ; BD94 90 90                    ..
        rts                                     ; BD96 60                       `

; ----------------------------------------------------------------------------
        bcc     LBD29                           ; BD97 90 90                    ..
        brk                                     ; BD99 00                       .
        bcc     LBD2C                           ; BD9A 90 90                    ..
        cpx     #$40                            ; BD9C E0 40                    .@
        rti                                     ; BD9E 40                       @

; ----------------------------------------------------------------------------
        brk                                     ; BD9F 00                       .
        beq     LBDB2                           ; BDA0 F0 10                    ..
        jsr     LF040                           ; BDA2 20 40 F0                  @.
        brk                                     ; BDA5 00                       .
        .byte   $70                             ; BDA6 70                       p
LBDA7:  rti                                     ; BDA7 40                       @
...
; ----------------------------------------------------------------------------
        bvs     LBDAC                           ; BDAA 70 00                    p.
LBDAC:  brk                                     ; BDAC 00                       .
LBDAD:  .byte   $80                             ; BDAD 80                       .
        rti                                     ; BDAE 40                       @
...
; ----------------------------------------------------------------------------
        brk                                     ; BDDB 00                       .
        bpl     LBE4E                           ; BDDC 10 70                    .p
        bcc     LBD70                           ; BDDE 90 90                    ..
        .byte   $70                             ; BDE0 70                       p
LBDE1:  brk                                     ; BDE1 00                       .
LBDE2:  brk                                     ; BDE2 00                       .
LBDE3:  rts                                     ; BDE3 60                       `
...
; ----------------------------------------------------------------------------
        .byte   $80                             ; BDE9 80                       .
        .byte   $E0                             ; BDEA E0                       .
LBDEB:  .byte   $80                             ; BDEB 80                       .
LBDEC:  .byte   $80                             ; BDEC 80                       .
LBDED:  brk                                     ; BDED 00                       .
        brk                                     ; BDEE 00                       .
        rts                                     ; BDEF 60                       `

; ----------------------------------------------------------------------------
        bcc     LBDE2                           ; BDF0 90 F0                    ..
        bpl     LBE54                           ; BDF2 10 60                    .`
        .byte   $80                             ; BDF4 80                       .
        cpx     #$90                            ; BDF5 E0 90                    ..
        bcc     LBD89                           ; BDF7 90 90                    ..
LBDF9:  brk                                     ; BDF9 00                       .
        rti                                     ; BDFA 40                       @
...
; ----------------------------------------------------------------------------
        brk                                     ; BE11 00                       .
        brk                                     ; BE12 00                       .
        bcc     LBE05                           ; BE13 90 F0                    ..
        bcc     LBDA7                           ; BE15 90 90                    ..
        brk                                     ; BE17 00                       .
        brk                                     ; BE18 00                       .
        cpx     #$90                            ; BE19 E0 90                    ..
LBE1B:  bcc     LBDAD                           ; BE1B 90 90                    ..
        brk                                     ; BE1D 00                       .
        brk                                     ; BE1E 00                       .
        rts                                     ; BE1F 60                       `

; ----------------------------------------------------------------------------
        bcc     LBDB2                           ; BE20 90 90                    ..
        rts                                     ; BE22 60                       `
...
; ----------------------------------------------------------------------------
        ...
        brk                                     ; BE24 00                       .
        cpx     #$90                            ; BE25 E0 90                    ..
        bcc     LBE09                           ; BE27 90 E0                    ..
        .byte   $80                             ; BE29 80                       .
        brk                                     ; BE2A 00                       .
        bvs     LBDBD                           ; BE2B 70 90                    p.
        bcc     LBE9F                           ; BE2D 90 70                    .p
        bpl     LBE31                           ; BE2F 10 00                    ..
LBE31:  bvs     LBE73                           ; BE31 70 40                    p@
        rti                                     ; BE33 40                       @
...
; ----------------------------------------------------------------------------
        brk                                     ; BE35 00                       .
        brk                                     ; BE36 00                       .
        bvs     LBDF9                           ; BE37 70 C0                    p.
        bmi     LBE1B                           ; BE39 30 E0                    0.
        brk                                     ; BE3B 00                       .
        rti                                     ; BE3C 40                       @
...
; ----------------------------------------------------------------------------
        brk                                     ; BE41 00                       .
        brk                                     ; BE42 00                       .
        bcc     LBDD5                           ; BE43 90 90                    ..
        bcc     LBEB7                           ; BE45 90 70                    .p
        brk                                     ; BE47 00                       .
LBE48:  brk                                     ; BE48 00                       .
        bcc     LBDEB                           ; BE49 90 A0                    ..
        ldy     #$40                            ; BE4B A0 40                    .@
        brk                                     ; BE4D 00                       .
LBE4E:  brk                                     ; BE4E 00                       .
        bcc     LBDE1                           ; BE4F 90 90                    ..
        beq     LBDE3                           ; BE51 F0 90                    ..
        brk                                     ; BE53 00                       .
LBE54:  brk                                     ; BE54 00                       .
        bcc     LBEB7                           ; BE55 90 60                    .`
        rts                                     ; BE57 60                       `

; ----------------------------------------------------------------------------
        bcc     LBE5A                           ; BE58 90 00                    ..
LBE5A:  brk                                     ; BE5A 00                       .
        bcc     LBDED                           ; BE5B 90 90                    ..
        bvs     LBE6F                           ; BE5D 70 10                    p.
        rts                                     ; BE5F 60                       `

; ----------------------------------------------------------------------------
        brk                                     ; BE60 00                       .
        beq     LBE83                           ; BE61 F0 20                    . 
        rti                                     ; BE63 40                       @
...
; ----------------------------------------------------------------------------
        ...
        brk                                     ; BE9A 00                       .
        brk                                     ; BE9B 00                       .
        jsr     L8070                           ; BE9C 20 70 80                  p.
LBE9F:  bvs     LBEC1                           ; BE9F 70 20                    p 
        brk                                     ; BEA1 00                       .
        jsr     L20F0                           ; BEA2 20 F0 20                  . 
        beq     LBEE7                           ; BEA5 F0 40                    .@
        brk                                     ; BEA7 00                       .
        brk                                     ; BEA8 00                       .
        jsr     L2070                           ; BEA9 20 70 20                  p 
        .byte   $20                             ; BEAC 20                        
LBEAD:  brk                                     ; BEAD 00                       .
        brk                                     ; BEAE 00                       .
        brk                                     ; BEAF 00                       .
        jsr     L20F0                           ; BEB0 20 F0 20                  . 
        brk                                     ; BEB3 00                       .
        brk                                     ; BEB4 00                       .
        .byte   $20                             ; BEB5 20                        
        .byte   $20                             ; BEB6 20                        
LBEB7:  bvs     LBED9                           ; BEB7 70 20                    p 
        brk                                     ; BEB9 00                       .
        brk                                     ; BEBA 00                       .
        brk                                     ; BEBB 00                       .
LBEBC:  rti                                     ; BEBC 40                       @
...
; ----------------------------------------------------------------------------
        beq     LBEFF                           ; BEBD F0 40                    .@
        brk                                     ; BEBF 00                       .
        brk                                     ; BEC0 00                       .
LBEC1:  bvc     LBEE3                           ; BEC1 50 20                    P 
        bvc     LBEC5                           ; BEC3 50 00                    P.
LBEC5:  brk                                     ; BEC5 00                       .
        beq     LBE48                           ; BEC6 F0 80                    ..
LBEC8:  rts                                     ; BEC8 60                       `

; ----------------------------------------------------------------------------
        .byte   $80                             ; BEC9 80                       .
        beq     LBECC                           ; BECA F0 00                    ..
LBECC:  brk                                     ; BECC 00                       .
        .byte   $20                             ; BECD 20                        
        .byte   $50                             ; BECE 50                       P
LBECF:  dey                                     ; BECF 88                       .
...
; ----------------------------------------------------------------------------
        brk                                     ; BEDF 00                       .
        beq     LBEE2                           ; BEE0 F0 00                    ..
LBEE2:  rts                                     ; BEE2 60                       `

; ----------------------------------------------------------------------------
LBEE3:  brk                                     ; BEE3 00                       .
        brk                                     ; BEE4 00                       .
        bvc     LBE87                           ; BEE5 50 A0                    P.
LBEE7:  bvs     LBEE9                           ; BEE7 70 00                    p.
LBEE9:  brk                                     ; BEE9 00                       .
